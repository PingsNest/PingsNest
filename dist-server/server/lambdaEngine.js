    ...
    const findings = [
        {
            ...
            evidence: isLegacy ? 'Inferred from function name pattern: BatchSyncJob' : 'No public Function URL detected.',
        ...
        },
        {
            ...
            evidence: isInvoice ? 'Inferred from function name: DB_PASSWORD-style variable likely present in DocGenerator.' : 'No plaintext secret patterns detected.',
        ...
        },
        {
            ...
            evidence: isLegacy ? 'Inferred from function name pattern: no DLQ configured for BatchSyncJob.' : 'DLQ or On-Failure destination appears configured.',
        ...
        },
        {
            ...
            severity: isLegacy ? 'HIGH' : 'PASSED',
            evidence: isLegacy ? 'Inferred from function name: BatchSyncJob likely uses a deprecated runtime (Python 3.8).' : 'Runtime version is actively supported.',
    ...
    const recentSecurityEvents = [
        {
            ...
            functionName: functionAudits[0]?.functionName || 'WorkerProcessor',
            severity: 'warning',
        ...
        },
        {
            ...
            functionName: functionAudits[1]?.functionName || 'BatchSyncJob',
            severity: 'critical',
        ...
        },
        {
            ...
            functionName: functionAudits[2]?.functionName || 'DocGenerator',
            severity: 'high',
