...
export const SAMPLE_NODES: TopologyNode[] = [
  ...
  { id: 'fn-payment', name: 'WorkerProcessor Lambda', category: 'Lambda Function', status: 'Healthy', latencyMs: 380, throughputRps: 380, errorRatePct: 0.4, details: 'Node.js 20.x • 1024 MB • Warm Start' },
  { id: 'fn-invoice', name: 'DocGenerator Lambda', category: 'Lambda Function', status: 'Warning', latencyMs: 4200, throughputRps: 85, errorRatePct: 4.8, details: 'Java 17 • 2048 MB • Memory Pressure' },
